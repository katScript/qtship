          ...
          <div class="warehouse-product-management">
            <div class="form-filter">
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" v-model="warehouseData.name"
                      placeholder="Tên kho/Tên cửa hàng" required />
                  </div>
                  <div class="form-group">
                    <label for="">Địa chỉ:</label>
                    <small class="text-danger">{{ msgValidationFor.warehouse.address }}</small>
                    <LocationPicker @updateAddress="updateAddress" :dataValidate="customerData.errors.customerAddress"
                      ref="locationPicker" :warehouseData="warehouseData"/>
                  </div>
                  <div class="form-group">
                    <label for="">Thông tin liên hệ:</label>
                    <small class="text-danger">{{ msgValidationFor.warehouse.phone }}</small>
                    <input type="text" class="form-control" v-model="warehouseData.phone"
                  ...
                  <easy-data-table :headers="headersWarehouse" :items="listWarehouseByCustomer"
                    ...
                    <template #item-btn-function="item">
                      ...
                      <table class="w-100">
                        <tr>
                          <td>
                            <a v-on:click="selectWareHouseForUpdate(item)" class="btn btn-success a-function a-detail"
                              data-bs-toggle="tooltip" data-bs-placement="top" title="Cập nhật"><i
                                class="fa-solid fa-file-pen"></i></a>
                          </td>
                          <td>
                            <a v-on:click="deleteWareHouse(item)" class="btn btn-danger a-function a-detail"
              ...
              <div class="create-product-management">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="" v-model="productData.name"
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="" v-model="productData.sku"
                  ...
                  <div class="row">
                    <div class="col-sm-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" v-model="productData.basePrice"
                    ...
                    <div class="col-sm-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" v-model="productData.publicPrice"
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" v-model="productData.weight"
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                          <div class="col-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" v-model="productData.qty"
                          ...
                          <div class="col-8">
                            <div class="form-group">
                              ...
                              <small class="text-success" v-if="productData.image">
                                Ảnh sản phẩm đã được tải lên trước đó!</small>
                              <input type="file" class="form-control" ref="productImgUpload"
                                v-on:click="loadingImgUpload = true" v-on:change="handleFileUpload()" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea name="" id="" v-model="productData.description" cols="30" rows="5"
                            class="form-control"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3 d-flex justify-content-end">
                      <div class="spinner-border m-auto" role="status" v-if="loadingImgUpload">
                        <span class="sr-only">Loading...</span>
                      </div>
                      <div class="img-product-upl m-auto" v-else>
                        <img alt="" width="200" height="200" class="" v-if="!urlImgProductUpload && !productData.image"
                          src="@/images/img-default.jpg" />
                        <img alt="" width="200" height="200" class="" v-else-if="urlImgProductUpload"
                          :src="urlImgProductUpload" />
                        <img alt="" width="200" height="200" class="" v-else-if="productData.image"
                ...
                <div class="d-flex justify-content-center">
                  <button class="btn btn-success btn-function-crud m-auto w-25" v-if="!isUpdateProductAction"
            ...
            <div class="warehouse-product-management-area">
              <div class="row">
                <easy-data-table :headers="headersProduct" :items="listProductByCustomer"
                  table-class-name="easy-data-table-customize">
                  <template #loading>
                    <img src="@/images/loading-gif.gif" style="width: 80px; height: 80px" />
                  </template>
                  <template #item-createdAt="item">
                    {{ formatDateYYYYMMDD(item.createdAt) }}
                  </template>
                  <template #item-image="item">
                    <img :src="item.data.image" style="width: 80px; height: 80px" />
                  </template>
                  <template #item-btn-function="item">
                    <!-- #item-btn-function="item"  item: valua of row-->
                    <table class="w-100">
                      <tr>
                        <td>
                          <a v-on:click="selectProductForUpdate(item)" class="btn btn-success a-function a-detail"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Cập nhật"><i
                              class="fa-solid fa-file-pen"></i></a>
                        </td>
                        <td>
                          <a v-on:click="deleteProduct(item)" class="btn btn-danger a-function a-detail"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Xóa"><i
                              class="fa-solid fa-trash"></i></a>
                        </td>
                      </tr>
