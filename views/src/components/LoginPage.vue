                    ...
                    <div class="div-form-login">
                        <div class="w-75 mx-auto">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="radio-remember-account"
                                    v-model="rememberMe">
        ...
        methods: {
                    ...
                    axios
                        ...
                        .then((response) => {
                            ...
                            if(resData.accessToken && !this.cookies.get('authenication_cookies')) {
                                ...
                                this.cookies.set("authenication_cookies", authenCookie, commonFunction.EXPIRED_TIME_COOKIES);
            ...
            validationForm: function () {
                ...
                if (this.username == "" && !this.username) {
                    this.validationUsername.push("Vui lòng điền đầy đủ thông tin đăng nhập!");
                    this.isValid += 1;
