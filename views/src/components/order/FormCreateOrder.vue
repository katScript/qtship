<template>
            ...
            <div class="row">
              <a-col class="col-md-6">
                ...
                <div class="border mt-3">
                  <div class="fs-5 border-bottom bg-danger px-3 py-1 text-white">Thông tin người nhận</div>
                  <div class="p-3">
              ...
              <a-col class="col-md-6">
                <div class="border">
                  <div class="fs-5 border-bottom bg-danger px-3 py-1 text-white">Phương thức giao & lấy hàng</div>
                  <div class="p-3">
  ...
  <script setup>
    ...
    dataSample.senderAddress = customerStorage.addressSet[0].street
                  + ", "
                  + customerStorage.addressSet[0].ward
                  + ", "
                  + customerStorage.addressSet[0].district
                  + ", "
                  + customerStorage.addressSet[0].province;
