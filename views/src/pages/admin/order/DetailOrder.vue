    ...
    <div class="content">
      <div class="border">
        ...
        <div class="p-3">
          ...
          <div class="">
            <span class="font-weight-bold">Tổng khối lượng: </span
            >{{ detail?.totalWeight }}
          </div>
          <div class="">
      ...
      <a-row type="flex" class="my-4" :gutter="[10, 10]" align="top">
        <a-col :span="8">
          <div class="border">
            ...
            <div class="p-3">
              ...
              <div>
                <span class="font-weight-bold">Tên người gửi: </span
                >{{ detail?.senderName }}
              </div>
              <div>
        ...
        <a-col :span="8">
          <div class="border">
            ...
            <div class="p-3">
              <div>
                <span class="font-weight-bold">Mã shipper: </span
                >{{ detail?.shipper?.shipperCode }}
              </div>
              <div>
                <span class="font-weight-bold">Tên shipper: </span
                >{{ detail?.shipper?.fullName }}
              </div>
              <div>
                <span class="font-weight-bold">Số điện thoại: </span
              ...
              <div>
                <span class="font-weight-bold">Dịch vụ giao hàng: </span
                >{{ detail?.shippingType }}
              </div>
            </div>
          </div>
        ...
        <a-col :span="8">
          <div class="border">
            ...
            <div class="p-3">
              ...
              <div>
                <span class="font-weight-bold">Đường - xã / phường: </span
          ...
          <a-list item-layout="vertical" :data-source="detail?.products">
            <template #renderItem="{ item }">
              <a-list-item key="item.title">
                ...
                <div class="">
                  <span class="font-weight-bold">Giá tiền: </span
                  >{{ item?.price }}
                </div>
                <div class="">
                  <span class="font-weight-bold">Khối lượng: </span
                  >{{ item?.weight }}
                </div>
                <div class="">
                  <span class="font-weight-bold">Tổng giá tiền: </span
                  >{{ item?.qty * item?.price }}
                </div>
                <div class="">
                  <span class="font-weight-bold">Tổng khối lượng: </span
